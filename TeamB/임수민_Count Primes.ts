...
// i*i < n 은 i < √n 과 같은 걸 표현한것이고, 2부터 n의 제곱근까지 판별하고 j는 i의 제곱부터 n까지 i씩 증가하면서 false로 변경해줍니다.
// 예를 들어 n = 30 일때, i = 2 일때 j = 4 부터 30까지 2씩 증가하면서 false로 변경해줍니다.
// 그 뒤 i = 3 일때 j = 9 부터 30까지 3씩 증가하면서 false로 변경해주고
// i = 4 일때는 이미 제거되었기 때문에 건너뜁니다.
// i = 5 일때는 5의 배수들을 제거하고, 이걸 i*i < n 까지 반복합니다.
